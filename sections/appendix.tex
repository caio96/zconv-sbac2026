\section{\algname Support for Dilation and Grouped Convolution}
\label{appendix:zconv-alg-ext}
...
The supplementary material provided with this submission includes:
...
\end{enumerate*}
Due to size restrictions, a docker image is not included, but will be made available when this material is packaged into an archival format. 

Full reproduction instructions included in the artifact README. The artifact is anonymized and contains no public repository URLs or author-identifying information; upon acceptance we will publish the full artifact (code, docker image, and evaluation scripts) with a public archive and DOI. % TODO: add instruction for deeplabv3plus evaluation