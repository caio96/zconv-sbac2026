...
The first three models in Figure~\ref{fig:torch-multi} stand out for obtaining the highest speedups with \algname.
...
Upon acceptance, the authors will package the following components into an archival format and make it publicly available with a DOI:
