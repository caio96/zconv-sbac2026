...
Integrating \algname into PyTorch's hybrid convolution implementation for end-to-end model evaluation results in inference speedups of up to 1.8$\times$ over unmodified PyTorch.
...
\begin{enumerate}[label=(\roman*),noitemsep,topsep=0pt] 
    ...
    \item A publicly available artifact containing all implementations and evaluation scripts.\footnote{Will be packaged upon publication, but the code was submitted as supplementary material.}
\end{enumerate}
