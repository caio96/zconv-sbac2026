...
Peak memory is measured as maximum resident set size (RSS) via \texttt{/usr/bin/time -v}, using the same fixed 100-iteration build as the Perf measurements in \rsec{standalone-conv}, run single-threaded on the six layers from \rtab{perf-layers}.
