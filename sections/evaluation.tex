...
Large-kernel configurations (\eg, $32\times32$ patch-embedding layers in ViT models, where $\texttt{IC}=3$) fall in the same category and are similarly excluded; their speedups over Im2col are captured in \rfig{im2col-comparison-multi}.
